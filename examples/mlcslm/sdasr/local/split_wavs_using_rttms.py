...
def split_wavs_using_rttms(rttm_dir, dev_data_dir, output_dir):
    ...
    for lang in languages:
        lang_dir = os.path.join(dev_data_dir, lang)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dev_data_dir', type=str, help='The directory of dev sets')
    ...
    split_wavs_using_rttms(rttm_dir, dev_data_dir, output_dir)
